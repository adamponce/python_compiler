def date(month, day, year):
    ...
    if month == "may" and day <= months["may"]:
        return months["january"] + february + months["march"] + \
               months["april"] + day
    if month == "june" and day <= months["june"]:
        return months["january"] + february + months["march"] + months[
            "april"] + months["may"] + day
    if month == "july" and day <= months["july"]:
        return months["january"] + february + months["march"] + months[
            "april"] + months["may"] + months["june"] + day
    if month == "august" and day <= months["august"]:
        return months["january"] + february + months["march"] + months[
            "april"] + months["may"] + months["june"] + months["july"] + day
    if month == "september" and day <= months["september"]:
        return months["january"] + february + months["march"] + months[
            "april"] + months["may"] + months["june"] + months["july"] + \
               months["august"] + day
    if month == "october" and day <= months["october"]:
        return months["january"] + february + months["march"] + months[
            "april"] + months["may"] + months["june"] + months["july"] + \
               months["august"] + months["september"] + day
    if month == "november" and day <= months["november"]:
        return months["january"] + february + months["march"] + months[
            "april"] + months["may"] + months["june"] + months["july"] + \
               months["august"] + months["september"] + months["october"] + day
    if month == "december" and day <= months["december"]:
        return months["january"] + february + months["march"] + months[
            "april"] + months["may"] + months["june"] + months["july"] + \
               months["august"] + months["september"] + months["october"] + \
               months["november"] + day
    else:
        return -1
